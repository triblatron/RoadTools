...
class RoadDesignerTests(unittest.TestCase):
    ...
    @parameterized.expand([
        ...
        ("data/tests/Road/arc.toml", "segment.tessellation.points[0][0]", 0.0),
        ("data/tests/Road/arc.toml", "segment.tessellation.points[0][1]", 0.0),
        ("data/tests/Road/arc.toml", "segment.tessellation.points[1][0]", 0.4233201742172241),
        ("data/tests/Road/arc.toml", "segment.tessellation.points[1][1]", 25.19525909423828),
        ("data/tests/Road/arc.toml", "segment.tessellation.distance[0]", 0.0),
        ("data/tests/Road/arc.toml", "segment.tessellation.distance[1]", 252.0/10.0),
        ("data/tests/Road/arc.toml", "surface.points[2].position.x", -3.226839065551758),
        ("data/tests/Road/arc.toml", "surface.points[2].position.y", 25.190521240234375),
        ("data/tests/Road/arc.toml", "surface.points[2].tex_coord.x", 0.0),
        ("data/tests/Road/arc.toml", "surface.points[2].tex_coord.y", 2.7970683574676514),
